        ...
        <div class="header-content">
            ...
            <nav class="row header-nav-wrap">
                <ul class="header-nav">
                    ...
                    <li><a href="mailto:moreno.robyn.info@gmail.com" title="Contact us">Say Hello</a></li>
                </ul>
    ...
    <section id="hero" class="s-hero target-section" data-parallax="scroll" data-image-src="images/hero-bg-3000.jpg" data-natural-width=3000 data-natural-height=2000 data-position-y=center>
        ...
        <div class="row hero-content">
            ...
            <div class="column large-full">
                ...
                <h1>
                Hello, I'm Moreno , <br>
                a System en Network Administrator <br>
                & Photographer<br>
                based in Belgium.
                </h1>
                ...
                <ul class="hero-social">
                    <li>
                        <a href="https://be.linkedin.com/in/moreno-robyn-b1a244179" title="">Linkedin</a>
                    </li>
        ...
        <div class="s-about__section s-about__section--profile">
            ...
            <div class="row">
                <div class="column large-6 medium-8 tab-full">
                    ...
                    <p data-aos="fade-up">
                     I'm the kind of person who isn't afraid of challenges , Thanks to my passion for ICT and automating infrastructure.
                     I can ensure you that i'm the right person to solve and improve you're ICT needs.
                    </p>
            ...
            <div class="row block-large-1-2 block-900-full work-positions">
                ...
                <div class="column" data-aos="fade-up">
                    <div class="position">
                        <div class="position__header">
                            <h6>
                                <span class="position__co">Excentis</span>
                                <span class="position__pos">System en Network enginer</span>
                            </h6>
                ...
                <div class="column" data-aos="fade-up">
                    <div class="position">
                        <div class="position__header">
                            <h6>
                                <span class="position__co">Tupperware Brands</span>
                                <span class="position__pos">ICT Support / SCCM Administrator</span>
                            </h6>
                            <div class="position__timeframe">
                                July 2021 - September 2021
                            </div>
                            <div class="position__timeframe">
                                Januari 2022 - Present
                            </div>
                        </div>
                ...
                <div class="column" data-aos="fade-up">
                    <div class="position">
                        <div class="position__header">
                            <h6>
                                <span class="position__co">Codefever</span>
                                <span class="position__pos">Assistant Teacher Programing fundamentels</span>
                            </h6>
                            <div class="position__timeframe">
                ...
                <div class="column" data-aos="fade-up">
                    <div class="position">
                        <div class="position__header">
                            <h6>
                                <span class="position__co">Noa informatica</span>
        ...
        <div class="row s-services__content">
            ...
            <div class="column large-6 s-services__leftcol">
                <div class="section-intro" data-num="02" data-aos="fade-up">
                    ...
                    <h1 class="display-1">
                    I focus on automating and securing my clients infrastructure .
                    </h1>
                </div>
                ...
                <ul class="services-list" data-aos="fade-up">
                    <li class="services-list__item is-active">
                        ...
                        <div class="services-list__item-body">
                            <p>
                            Sick of managing applicatication manuly, Spending to much time auditing your systems?
                            Well as intune/sccm expert, I can help you manage and securing your endpoints. Using something else?
                            Feel free to contact us to design a sollution made to your company's needs.
                            </p>
                        </div>
                    ...
                    <li class="services-list__item">
                        ...
                        <div class="services-list__item-body">
                            <p>
                            Busy with devops? Having to manage a bunch of server or even a hole datacenter? As a authortie on infrastructure as code i can help you!
                            Design and setup your infrastructure as code needs! I am ansible & Saltstack developer so any problem with one of these feel free to contact <menu></menu>
                            </p>
                        </div>
                    </li> <!-- services-list__item -->
                    <li class="services-list__item">
                    ...
                    <li class="services-list__item">
                        <div class="services-list__item-header">
                            <h5>On premis Linux/Windows Server</h5>
                        </div>
                        <div class="services-list__item-body">
                            <p>
